...
<template>
  ...
  >
    <el-descriptions :column="1" border
      ><el-descriptions-item :label="t('reservation.reservationNo')">{{
        reservation?.reservationNo
      }}</el-descriptions-item
      ><el-descriptions-item :label="t('reservation.guest')">{{
        reservation?.guestName
      }}</el-descriptions-item
      ><el-descriptions-item :label="t('frontDesk.assignedRoom')">{{
        reservation?.assignedRoomNumber || t("common.unassigned")
